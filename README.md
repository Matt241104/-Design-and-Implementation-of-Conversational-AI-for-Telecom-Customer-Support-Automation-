...
- Integration with ClickUp tasks and workflows
...
5. Escalates if needed by creating a task
...
## Screenshots
(Add images showing chatbot responses, workflows, automations)
...
## Notes
This project demonstrates how workflow automation platforms can be used to simulate chatbot behavior without traditional backend development.
